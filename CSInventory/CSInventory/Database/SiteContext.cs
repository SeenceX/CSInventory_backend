...
namespace CSInventory.Database
{
    ...
    public class SiteContext : DbContext
    {
        ...
        public DbSet<ItemQuality> ItemsQuality { get; set; }
        public DbSet<ItemRare> itemsRares { get; set; }
